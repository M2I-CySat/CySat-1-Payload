...
# Generated: Thu Jan  1 00:05:13 1970
##################################################
...
class N200_TPR(grc_wxgui.top_block_gui):
    ...
    def __init__(self, devid="addr=192.168.10.2", fftsize=8192, frequency=1.4125e9, subdev="A:0"):
...
if __name__ == '__main__':
    ...
    tb = N200_TPR(devid=options.devid, fftsize=options.fftsize, frequency=options.frequency, subdev=options.subdev)
    tb.Start(True)
    tb.Wait()
